...
<p className="text-xl leading-relaxed text-gray-600 dark:text-gray-400 mb-2">Essays and articles on design engineering and building in the startup space.</p>

<p className="text-sm italic text-gray-400 dark:text-gray-500 mt-6 mb-10">Originally published on <a href="https://medium.com/@maria_cristoforo" className="muted-link" target="_blank" rel="noopener noreferrer">Medium</a>, republished here with minor edits</p>
