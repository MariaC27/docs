...
<p className="font-serif text-lg leading-relaxed text-gray-600 dark:text-gray-400 mb-8">An API-style reference of my capabilities, tools, and proficiency levels.</p>
