...
<p className="font-serif text-lg leading-relaxed text-gray-600 dark:text-gray-400 mb-8">An API-style reference of my capabilities, tools, languages, and their proficiency levels.</p>
...
<div className="my-8" id="skill-typescript">
  ...
  <p className="mb-6 text-gray-600 dark:text-gray-400">My primary language for frontend work. Comfortable using across large codebases with complex props and API response types.</p>
...
<div className="my-8" id="skill-customer-communication">
  ...
  <p className="mb-6 text-gray-600 dark:text-gray-400">Interacted directly with customers at scale while in support engineering at Atlassian. Translated product friction observations into actionable feedback, communicated technical issues clearly and professionally.</p>
  ...
  **Parameters**
  ...
  |------|-------|
  | `last_used` | 2023 |
  | `focus_areas` | Customer support, providing action-oriented feedback |
