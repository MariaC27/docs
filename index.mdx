  ...
  <div className="max-w-2xl font-serif text-lg leading-relaxed text-gray-700 dark:text-gray-300 portfolio-dropcap-section">
    <p>
      <span className="portfolio-dropcap leading-[0.85]">I</span>
        work at the intersection of design and engineering, owning features end-to-end on small, fast-moving teams. I consider design principles throughout the ideation and development process, rather than treating design as a separate step at the beginning or end. My work is shaped by an interdisciplinary background in computer science and human-centered design, along with interests in psychology and writing. I believe storytelling, user empathy, and a strong sense of taste are what set great interfaces - and designers - apart, and I aim to bring those qualities to every project.
    </p>
  </div>
