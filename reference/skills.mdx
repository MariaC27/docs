...
<p className="font-serif text-lg leading-relaxed text-gray-600 dark:text-gray-400 mb-8">A structured API-style reference of my capabilities, tools, and proficiency levels.</p>
...
<div className="my-8" id="skill-htmlcss">
  ...
  <p className="mb-6 text-gray-600 dark:text-gray-400">Solid command of semantic HTML and CSS fundamentals — flexbox, grid, animations, custom properties</p>
...
<div className="my-8" id="skill-python">
  ...
  <p className="mb-6 text-gray-600 dark:text-gray-400">Comfortable with Python for scripting, tooling, and backend logic</p>
  ...
  **Parameters**
  ...
  | `years_experience` | 6 |
  | `last_used` | Early 2025 |
  | `context` | Scripting, backend logic, data processing |
...
<div className="my-8" id="skill-java">
  ...
  <p className="mb-6 text-gray-600 dark:text-gray-400">Where I first learned to code. Used throughout Dartmouth CS coursework and FIRST Robotics. Not in active use but the foundations are there.</p>
...
<div className="my-8" id="skill-figma">
  ...
  <p className="mb-6 text-gray-600 dark:text-gray-400">Comfortable making wireframes, hifi prototypes, and design systems, though I currently use Figma more for making assets rather than full mockups.</p>
...
<div className="my-8" id="skill-ai-design">
  ...
  <p className="mb-6 text-gray-600 dark:text-gray-400">My current rapid design process leverages AI prototyping tools to get interactive mockups, then iterating from there, allowing me to focus on the broader picture and the reasoning behind each design decision.</p>
